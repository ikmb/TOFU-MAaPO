#!/usr/bin/env python3
# This script merges multiple relative abundance from metaphlan read tables into one. This is an alternative to merge_metaphlan_tables.py, supplied by the Metaphlan authors,
...
def merge( aaastrIn, ostm ):
    ...
    for f in aaastrIn:
        ...
        iIn.drop(['estimated_number_of_reads_from_the_clade','coverage'],axis=1,inplace=True)
