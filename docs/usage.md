...
- `--min_raw_reads` Skip samples with fewer than this many raw reads. Default: 0 (disabled).
- `--min_qced_reads` Skip samples with fewer than this many reads after QC. Default: 0 (disabled).
...
- `--binner` Comma-separated list of binning tools (default: "concoct,maxbin,semibin,metabat,vamb,comebin"). Options: **concoct**,**maxbin**,**semibin**,**metabat**,**vamb**,**comebin** <br />
