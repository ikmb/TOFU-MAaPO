...
This pipeline requires **Nextflow 21.04.0 or higher**. All other dependencies are containerized using **Singularity** and **Docker**.

By default, the pipeline is configured to use the **Kiel Medcluster** profile. 
...
## Input Options
### 1. FASTQ Files  
Use the `--reads` parameter with a **glob pattern** for your .fastq.gz files **or** 
...
**Should be executed in the first run of the respective module**
